...
export const translations: Translations = {
  ...
  personalizationTitle: {
    ...
    Hindi: 'एआई और वैयक्तिकरण',
    Marathi: 'एआय आणि वैयक्तिकरण',
    Hinglish: 'AI & Personalization',
  },
  aiVerbosity: {
    English: 'AI Verbosity',
    Hindi: 'एआई वर्बोसिटी',
    Marathi: 'एआय वर्बोसिटी',
    Hinglish: 'AI Verbosity',
  },
  concise: {
    English: 'Concise',
    Hindi: 'संक्षिप्त',
  ...
  healthGoal: {
    English: 'Health Goal',
    Hindi: 'स्वास्थ्य लक्ष्य',
    Marathi: 'आरोग्य ध्येय',
    Hinglish: 'Health Goal',
  },
  generalWellness: {
