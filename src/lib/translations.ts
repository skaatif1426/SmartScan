...
export const translations: Translations = {
  ...
  barcodeDesc: { English: 'Scan a product barcode via camera or upload an image.', Hindi: 'कैमरे के माध्यम के उत्पाद बारकोड स्कैन करें या छवि अपलोड करें।', Marathi: 'कॅमेराद्वारे उत्पादन बारकोड स्कॅन करा किंवा प्रतिमा अपलोड करा।', Hinglish: 'Barcode scan karo ya image upload karo.' },
  ...
  enterManually: { English: 'Enter Barcode Manually', Hindi: 'बारकोड मैन्युअल रूप से दर्ज करें', Marathi: 'बारकोड मॅन्युअली प्रविष्ट करा', Hinglish: 'Barcode manually likho' },
