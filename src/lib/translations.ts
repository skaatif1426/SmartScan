...
export const translations: Translations = {
  ...
  retry: { English: 'Retry', Hindi: 'पुनः प्रयास करें', Marathi: 'पुन्हा प्रयत्न करा', Hinglish: 'Phir se try karo' },
  ...
  generatingInsightError: { English: 'Unable to generate AI analysis at this moment.', Hindi: 'इस समय AI विश्लेषण तैयार करने में असमर्थ।', Marathi: 'यावेळी AI विश्लेषण व्युत्पन्न करण्यात अक्षम।', Hinglish: 'dek yrr kuch bhi assistance kaam nhi karre' },
