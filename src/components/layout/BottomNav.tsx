        ...
        {navItems.map((item) => {
          ...
          return (
            <Link
              ...
              href={item.href}
              className={cn(
                'flex flex-col items-center justify-center w-full h-full text-sm font-medium transition-all duration-200 ease-in-out active:scale-95',
                isActive ? 'text-primary scale-[1.05]' : 'text-muted-foreground hover:text-primary'
              )}
            >
