    ...
    <div className="space-y-8 pb-32 animate-in fade-in slide-in-from-bottom-10 duration-700 max-w-2xl mx-auto px-4">
      <div className="relative h-72 w-full rounded-3xl overflow-hidden shadow-2xl bg-muted group">
        ...
        <div className="absolute bottom-8 left-8 right-8 space-y-2">
             ...
             <p className="text-white/60 text-sm font-bold">{t('imageIntelligenceScan')}</p>
        </div>
      </div>
      ...
      <Accordion type="single" collapsible className="space-y-4">
        <InsightItem title={t('likelyIngredients')} content={result.insights.ingredients} value="item-1" />
        <InsightItem title={t('suggestedAlternatives')} content={result.insights.betterAlternatives} value="item-4" />
      </Accordion>
