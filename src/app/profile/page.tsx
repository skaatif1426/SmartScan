        ...
        <Card className="border shadow-sm">
            <CardContent className="p-6 space-y-4">
                <div className="flex justify-between items-end">
                    <div className="space-y-1">
                        <p className="text-xs uppercase tracking-widest text-muted-foreground font-bold">{t('contributorRank')}</p>
                        <div className="text-lg font-bold text-primary flex items-center gap-2">
                            {contributorLevel.icon} {contributorLevel.title}
                        </div>
                    </div>
                    <div className="text-right">
                        <p className="text-xs uppercase tracking-widest text-muted-foreground font-bold">{t('xpLevel')}</p>
                ...
                <p className="text-[10px] text-center text-muted-foreground">
                    {t('scanItemsLevelUp').replace('{next}', String(level + 1))}
                </p>
            </CardContent>
        </Card>
